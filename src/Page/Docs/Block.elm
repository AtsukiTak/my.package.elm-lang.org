...
makeInfo : String -> String -> String -> List Docs.Module -> Info
makeInfo author project moduleName docsList =
  let
  ...
  in
    Info author project moduleName <|
...
makeLink {author, project, moduleName} attrs tagName humanName =
  let
    url =
      Href.toModule author project moduleName (Just tagName)
  in
